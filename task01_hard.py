...
if age <= 30 and (weight < 50 or weight > 120):
    print('Ваши данные: ', name, surname, ',', 'возраст ', age, ',', 'вес', weight, '- следует заняться собой')
elif age >= 40 and (weight < 50 or weight > 120):
    print('Ваши данные: ', name, surname, ',', 'возраст ', age, ',', 'вес', weight, '- обратитесь к врачу')
elif age >= 30 and (50 <= weight <= 120):
    print('Ваши данные: ', name, surname, ',', 'возраст ', age, ',', 'вес', weight, '- ваше состояние в норме')
else:
    print('Ваши данные: ', name, surname, ',', 'возраст ', age, ',', 'вес', weight, '- пациенты вашего типа не обслуживаются нашей больницей')